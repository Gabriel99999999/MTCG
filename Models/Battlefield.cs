...
namespace MTCG.Models
{
    internal class Battlefield
    {
        ...
        public bool SpecialRule(User player1, User player2, Card card1, Card card2)
        {
            ...
            if ( (card1.Name is CardType.Dragon && card2.Name is CardType.Goblin)                       ||
                 ...
                 (card1.Element is ElementType.Fire && card1.Name is CardType.Elve) && card2.Name is CardType.Dragon))
            {
                winCard = card1;
            }
            //Bedigungen wo card2 gewinnt
            //Goblin vs Dragon || Ork vs Wizzard || Knight vs WaterSpell || spells vs Kraken ||Dragon vs FireElve
            else if ( (card1.Name is CardType.Goblin && card2.Name is CardType.Dragon)                     ||
                     ...
                     (card1.Name is CardType.Dragon && (card2.Element is ElementType.Fire && card2.Name is CardType.Elve)) )
            {
                winCard = card2;
            }
